...
CREATE TABLE "Annocement" (
    ...
    CONSTRAINT "Annocement_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Annocement" ADD CONSTRAINT "Annocement_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
